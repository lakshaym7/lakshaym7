...
<a href="https://github.com/lakshaym7">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&duration=3000&pause=1000&color=2F81F7&center=true&vCenter=true&width=650&lines=AI+Research+Engineer;Multimodal+GenAI+%26+Vision-Language+Systems;Healthcare+ML+%2B+Agentic+RAG+Pipelines;Best+Paper%2C+IEEE+ICDSBS+2025" alt="Typing SVG" />
</a>
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:madangop@usc.edu)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/lakshaym7)

![Profile views](https://komarev.com/ghpvc/?username=lakshaym7&color=2F81F7&style=flat)
...
![PennyLane](https://img.shields.io/badge/PennyLane-Quantum%20ML-informational?style=flat)
...
<br>*Python · RAG · Multi-Agent Systems · FastAPI* · [Repo](https://github.com/lakshaym7/healthcare-claims-ai-pipeline)
...
<br>*PyTorch · PennyLane · Vision Transformers · GPT-2* · [Repo](https://github.com/lakshaym7/Medical-Image-Captioning)
...
<br>*PyTorch · Multimodal Fusion · Medical Imaging*
...
<br>*Python · PyTorch · Robotics* · [Repo](#)
...
- **Real-Time Fall Detection Using ARIMA** &nbsp;`Best Paper, IEEE ICDSBS 2025`
  <br>A multi-camera, multi-person fall detection system pairing OpenPifPaf pose estimation with ARIMA time-series forecasting for real-time anomaly detection.
  <br>[![IEEE Xplore](https://img.shields.io/badge/IEEE%20Xplore-00629B?style=flat&logo=ieee&logoColor=white)](https://ieeexplore.ieee.org/document/11031929)

- **Enhancing Solar Cell Defect Detection through a Generalized Hybrid Transfer Learning Model** &nbsp;`Book Chapter`
  <br>A hybrid CNN and classical ML approach with LDA dimensionality reduction, reaching 97.41% accuracy on the ELPV electroluminescence dataset.
  <br>[![ResearchGate](https://img.shields.io/badge/ResearchGate-00CCBB?style=flat&logo=researchgate&logoColor=white)](https://www.researchgate.net/publication/395066049_Enhancing_Solar_Cell_Defect_Detection_through_a_Generalized_Hybrid_Transfer_Learning_Model_Synergized_with_Machine_Learning_Classifier)

---

## Open Source

- **HippoRAG** (OSU NLP Group) &nbsp;![Merged](https://img.shields.io/badge/🚀%20merged%20%26%20shipped-brightgreen?style=flat)
  <br>Built a pluggable storage abstraction for interchangeable vector backends with full backward compatibility, resolved cross-platform issues across a four-layer import chain that cut peak memory by 33%, and added a 36-test integration suite. Reviewed and landed in main within seven days.

- **Apache Cassandra** &nbsp;![In Review](https://img.shields.io/badge/⏳%20awaiting%20maintainer%20approval-yellow?style=flat)
  <br>Contributing to Cassandra's tooling through the project's ticket and code-review workflow, with a patch currently in review.
...
![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=lakshaym7&theme=tokyo-night&hide_border=true&area=true)

![Streak](https://streak-stats.demolab.com?user=lakshaym7&theme=tokyonight&hide_border=true)
